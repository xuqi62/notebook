...
青牛平台
SN：
00000100000760600001AC4AFE2BAAA0 （该账号已删除）
MAC：
AC4AFE2BAAA0 
用户名：
HSTEST00004@IPTV
...
海信内蒙IPTV自研中间件
烧录好了需要进uboot配置串口：按s键开机，进入uboot后，
然后setenv console ttyS0,115200，然后saveenv，然后reset重启
正常烧好是黑屏状态，需要按遥控的设置键进入设置，密码6321，
然后进高级设置去选择华为平台，设置账号haixin4，密码haixin4，点保存。
最后应该还要去网络设置里选择自动获取ip，然后重启就可以进去了
测试认证地址换 
...
(17:28) 黄惠保: 推库就行
(17:29) 黄惠保: 推完要 busybox killall mediaserver
